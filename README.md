...
To install, click the **[Download Latest](https://github.com/Roblo-Creator/RobloxAccountManager/releases/download/V1.6/RobloxAccountManager.exe)** button to download the latest `.exe` file. After downloading,  run the **Roblox Account Manager.exe** file to start the application.
