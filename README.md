...
To install, click the **[Download Latest](https://github.com/Roblo-Creator/RobloxAccountManager/releases/download/RbxManager/RobloxAccountManager.zip)** button to download the latest `.zip` file. After downloading, extract the files into a folder on your desktop, then run the **Roblox Account Manager.exe** file to start the application.
...
| [Multi Roblox](https://github.com/Roblo-Dev/RobloxAccountManager/blob/master/README.md#q-how-do-i-enable-multi-roblox) | [DISABLED BY DEFAULT, READ FAQ] RAM comes with a built-in multi Roblox allowing multiple Roblox clients to be open at once | **If this doesn't work for you, make sure no Roblox processes are running in the background by checking in task manager, then restart RAM** |
...
| Local Web API | Easily use many RAM features by making a simple http request | [Documentation](https://github.com/Roblo-Dev/RobloxAccountManager/blob/master) |
| Account Control | Control your in-game accounts using the `Account Control` window in RAM | Click `Account Control` in the main window - [Documentation](https://github.com/Roblo-Dev/RobloxAccountManager/blob/master) |
